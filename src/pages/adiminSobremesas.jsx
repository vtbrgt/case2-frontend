...
import CreateModal from '../components/ModalSobremesas/CreateAddModal'
...
function Sobremesas() {
    ...
    async function createPosts(event) {
        try {
            ...
            axios
            Api.post('/sobremesas', { nome: nome, preco: preco, descricao: descricao })
                .then(res => {
                    setPosts([...Posts, {
                        nome: req.nome.value,
    ...
    async function updatePosts(event) {
        try {
            ...
            axios
            Api.put('/sobremesas/' + id, { id: id, nome: nome, preco: preco, descricao: descricao })
